...
printHelp = do
  ...
  T.putStrLn "  (2) Cleaning up pragmas and adding a warning-silencing pragma"
  T.putStrLn "  (3) Fixing errors (misplaced imports and variables with illegal names)."
  T.putStrLn "  (4) Inserting all necessary qualified module imports."
  T.putStrLn "  (5) Optionally, inserting arbitrary extra code."
  T.putStrLn "  (6) Optionally, inserting extra constraints into type signatures."
  T.putStrLn ""
