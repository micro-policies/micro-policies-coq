  ...
  + (* machine1 steps*)
    ...
    - (*machine1 has CFI at all steps*)
      ...
      * (*case it's a visible STEP and In2 for machine1 is true*)
        ...
        { auto. }
        { 
        intro STEP. destruct (backwards_simulation_step asi csi csj REFI STEP) 
                    as [[? [asj' [STEP' REFJ']]] | [CONTRA ?]].
        destruct (step_determ asi asj asj' 
        { assert (STEP1: cfi_step machine1 asi asj) by (eapply interm_in2_step; eauto).
          destruct STEP1 as [STEP1A | STEP1N].
          - split; [apply attacker_pc | idtac].
            intro STEP. 
            destruct (backwards_refinement_single
